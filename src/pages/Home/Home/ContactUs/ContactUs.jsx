...
<section class="py-10 bg-gray-900 sm:py-16 lg:py-24 max-w-screen-xl mx-auto">
    <div class="max-w-6xl px-4 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:items-stretch md:grid-cols-2 gap-x-12 lg:gap-x-20 gap-y-10">
            <div class="flex flex-col justify-between lg:py-5">
                <div>
                    <h2 class="text-3xl font-bold leading-tight text-white sm:text-4xl lg:leading-tight lg:text-3xl">Contact With Us</h2>
                    <p class="max-w-xl mx-auto mt-4 text-base leading-relaxed text-white">Amet minim mollit non deserunt ullamco est sit aliqua dolor do amet sint. Velit officia consequat duis.</p>
                     <p className=' text-white mt-4'><HiPhoneArrowUpRight className='text-xl'></HiPhoneArrowUpRight>+88 01750 14 14 14</p>
                     <p className='text-white mt-4'><HiOutlineMapPin className='text-xl'></HiOutlineMapPin>Dhanmondi, Dhaka, Bangladesh</p>
                    ...
                    <div class="p-6 sm:p-10">
                        ...
                        <div className='flex gap-4'>
                            <div class="space-y-6">
                                ...
                                <div>
                                    <label for="" class="text-base font-medium text-gray-900"> Date </label>
                                    <div class="mt-2.5 relative">
                                <input type="date" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 caret-orange-500"/>
                                    </div>
                                </div>
                            </div>
                            <div class="space-y-6">
                                <div>
                                    <label for="" class="text-base font-medium text-gray-900"> Doctor name </label>
                                    <div class="mt-2.5 relative">
                                        <input
                                            type="text"
                                            name=""
                                ...
                                <div>
                                    <label for="" class="text-base font-medium text-gray-900"> Time </label>
                                    <div class="mt-2.5 relative">
                                <input type="time" class="block w-full px-4 py-4 text-black placeholder-gray-500 transition-all duration-200 bg-white border border-gray-200 rounded-md focus:outline-none focus:ring-orange-500 focus:border-orange-500 caret-orange-500"/>
                                    </div>
                                </div>
                            ...
                            <div>
                                    <button type="submit" class="inline-flex items-center justify-center mt-4 w-full px-4 py-4 text-base font-semibold text-white transition-all duration-200 bg-error border border-transparent rounded-md focus:outline-none hover:bg-orange-500 focus:bg-orange-600">
                                        Book Now
                                    </button>
                                </div>
                        </form>
