...
export default function Footer() {
  return (
    <div className=' border-t-2 border-black mt-24'><footer className="footer p-10 bg-base-200 text-base-content">
    <aside>
      ...
      <p className='text-2xl font-bold text-error'>Cure <span className='text-green-800'>Me</span><br/><span className='text-slate-400 text-lg'>Providing reliable services since 2002</span></p>
    </aside> 
    <nav>
    ...
    <nav>
      <header className="footer-title">Cure Me Services</header> 
  ...
  <hr className='bg-slate-300 w-5/6 divider mx-auto rounded -mt-8'/>
  <footer className="footer footer-center p-4 bg-base-200 text-base-content">
  <aside>
    <p>Copyright © 2023 - All right reserved by Cure Me Ltd</p>
  </aside>
</footer>
  </div>
  )
